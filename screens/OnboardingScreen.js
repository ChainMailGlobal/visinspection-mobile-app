  ...
  const slides = [
    {
      ...
      features: [
        { label: 'Foresight', description: 'Validate plans against building codes before submission' },
        { label: 'Eyesight', description: 'Real-time AR verification with Snap Spectacles' },
        { label: 'Hindsight', description: 'Post-construction compliance documentation' },
      ],
      valueNote: 'One prevented rework pays for the platform',
    },
    {
      title: 'AR Spectacles for Jobsites',
      subtitle: 'Hands-free inspection technology',
      features: [
        { label: 'AR Plan Overlays', description: 'View approved plans directly on site in real-time' },
        { label: 'AI Discrepancy Detection', description: 'Catch framing drift and clearance issues early' },
        { label: 'Voice-Controlled Documentation', description: 'Mark defects and generate reports hands-free' },
      ],
